...
<div>
  <form name="forml" method="post" action="form_ok.jsp"
    ...
    <label for="sAirport">출발지</label>
    <input type="text" id="sAirport" name="sAirport" placeholder="출발지"> &rarr; <label for="eAirport">도착지</label>
    <input type="text" id="eAirport" name="eAirport" Placeholder="도착지"><br><br>
